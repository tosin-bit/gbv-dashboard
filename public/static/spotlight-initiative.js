...
function loadSpotlightInitiative(section) {
    section.innerHTML = `
        <div class="space-y-6">
            ...
            <!-- Phase 3 Label -->
            <div class="flex items-center mb-2 mt-8">
                <h2 class="text-2xl font-bold text-gray-800 mr-3">Phase 3: Predictive Analytics & AI Intelligence</h2>
                <span class="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-semibold animate-pulse">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer group" 
                     onclick="showSpotlightSection('spike-prediction')">
                    <div class="bg-gradient-to-r from-purple-500 to-indigo-600 p-6 text-white">
                        <div class="flex items-center justify-between mb-3">
                            <i class="fas fa-chart-line text-5xl opacity-80"></i>
                            <span class="px-3 py-1 bg-white/20 rounded-full text-xs font-semibold">Phase 3</span>
                        </div>
                        <h3 class="text-2xl font-bold mb-2">Spike Prediction</h3>
                        <p class="text-purple-100 text-sm">7-day case forecasting by district</p>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-2 text-sm text-gray-700 mb-4">
                            <li class="flex items-start">
                ...
                <!-- Risk Scoring Card -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer group" 
                     onclick="showSpotlightSection('risk-scoring')">
                    <div class="bg-gradient-to-r from-pink-500 to-purple-600 p-6 text-white">
                        ...
                        <p class="text-pink-100 text-sm">Personalized survivor risk assessment</p>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-2 text-sm text-gray-700 mb-4">
                            <li class="flex items-start">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer group" 
                     onclick="showSpotlightSection('resource-forecast')">
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
                        <div class="flex items-center justify-between mb-3">
                        ...
                        <p class="text-blue-100 text-sm">Supply, staffing & budget predictions</p>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-2 text-sm text-gray-700 mb-4">
                            <li class="flex items-start">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer group" 
                     onclick="showSpotlightSection('trend-intelligence')">
                    <div class="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 text-white">
                        <div class="flex items-center justify-between mb-3">
                        ...
                        <p class="text-indigo-100 text-sm">Pattern detection & policy impact</p>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-2 text-sm text-gray-700 mb-4">
                            <li class="flex items-start">
