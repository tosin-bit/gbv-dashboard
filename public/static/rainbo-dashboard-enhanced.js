            ...
            <div class="bg-white rounded-xl shadow-lg mb-6">
                <div class="border-b border-gray-200">
                    <nav class="flex space-x-4 px-6" role="tablist">
                        ...
                        <button onclick="switchTab('report')" id="tab-report" class="py-4 px-4 border-b-2 border-transparent text-gray-500 hover:text-purple-600 font-semibold">
...
function switchTab(tabName) {
    // Update tab buttons
    const tabs = ['cases', 'report', 'statistics', 'followups'];
    tabs.forEach(tab => {
...
// Load GBV Report Form for Rainbo Portal
